...
// TYcPrint destructor
//
__fastcall TYcPrint::~TYcPrint(void)
{
}
//---------------------------------------------------------------------------
// get printer's info into member vars
//
TYcInfoDC __fastcall TYcPrint::GetInfo(void)
{
  return GetInfo(Printer()->Handle);
}

TYcInfoDC __fastcall TYcPrint::GetInfo(HDC hdc)
{
  TYcInfoDC info;
...
//
void __fastcall TYcPrint::SetMargins(TRect margins)
{
  // set margins
  FMargins = margins;
...
// and EndRender() calls
//
void TYcPrint::BeginRender(int maxPages)
{
...
//
void __fastcall TYcPrint::SetShowMargins(bool showMargins)
{
...
//
CHARRANGE __fastcall TYcPrint::GetSelRange(void)
{
  CHARRANGE chrg;
...
//
int __fastcall TYcPrint::GetSelStartPage(void)
{
...
//
int __fastcall TYcPrint::GetSelEndPage(void)
{
...
//
TYcPageOffsets __fastcall TYcPrint::GetOffsetPages(CHARRANGE chrg)
{
...
//
int __fastcall TYcPrint::GetPageCount(void)
{
...
::TTaePageRange __fastcall TYcPrint::GetOffsetPages(int begOffset,
                                                                int endOffset)
{
  TYcPageOffsets po;
...
// actual printing)
//
bool TYcPrint::PaginateTo(int page)
{
...
//
/*
int __fastcall TYcPrint::GetPrinterPageCount(void)
{
...
// set the printing flag, etc., and caller should not call any TYcPrint
...
// caller could screw up is by calling some TYcPrint function or
...
bool TYcPrint::RenderPage(HDC hdc, int w, int h, int page)
{
  // sanity check
...
// TYcPrint actually renders to should return the rendering area for
// the TYcPrint control.  this allows, say, a derived class to print
// headers and footers by returning the smaller rect actually used by
// the TYcPrint control here.  this virtual function (GetRenderRect) is
...
// iHeight = 15840 twips
TRect __fastcall TYcPrint::GetRendRect(HDC hdc, TRect rMargins,
                                                          int &w, int &h)
{
  TYcInfoDC info = GetInfo(hdc);
...
long int TYcPrint::FormatRange(TFormatRange& formatRange, bool render)
{
...
//
void TYcPrint::ClearRenderingCache(void)
{
...
//
void TYcPrint::BeforePage(HDC hdc, int page)
{
...
//
TRect TYcPrint::TwipsToRenderRect(TRect rect)
{
  TRect r;
...
//
TRect TYcPrint::TwipsToTargetRect(HDC hdc, TRect rect)
{
  TYcInfoDC info = GetInfo(hdc);
  TRect r;
...
/*
HDC __fastcall TYcPrint::CreatePrinterDC(void)
{
