...
#pragma resource "*.dfm"
TYcPrintCancelDialog* YcPrintCancelDialog;
//---------------------------------------------------------------------------
// ValidCtrCheck is used to assure that the components created do not have
// any pure virtual functions.
//
static inline void ValidCtrCheck(TYcPrintCancelDialog *)
{
  new TYcPrintCancelDialog(NULL);
}
//---------------------------------------------------------------------------
__fastcall TYcPrintCancelDialog::TYcPrintCancelDialog(TComponent* Owner)
  : TForm(Owner)
{
  FOnAbortPrint = 0;
}
//---------------------------------------------------------------------------
void __fastcall TYcPrintCancelDialog::CancelClick(TObject *Sender)
{
  if (OnAbortPrint)(OnAbortPrint)(this);
}
//---------------------------------------------------------------------------
void __fastcall TYcPrintCancelDialog::FormShow(TObject *Sender)
{
